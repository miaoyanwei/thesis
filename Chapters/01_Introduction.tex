...
\begin{itemize}
  ...
  \item Evaluate the impact of the developed interventions on households' thoughts of energy-efficient technologies and renewable energy sources, using both quantitative and qualitative methods.
...
\begin{table}[h]
  \begin{center}
    \begin{tabular}{ p{.05\textwidth} p{.80\textwidth} }
      \cellcolor[rgb]{0.94,0.96,0.98}1 & Read literature \\
      \cellcolor[rgb]{0.86,0.90,0.96}2 & Design \\ 
      \cellcolor[rgb]{0.78,0.84,0.94}3 & Develope \\
      \cellcolor[rgb]{0.71,0.78,0.92}4 & Evaluate \\
      \cellcolor[rgb]{0.63,0.73,0.89}5 & Analyse \\
      \cellcolor[rgb]{0.55,0.67,0.87}6 & Write thesis \\
      \cellcolor[rgb]{0.47,0.61,0.85}7 & Presentation and others \\
    \end{tabular}
    \caption{Process}
  ...
  \begin{center}
    ...
    \renewcommand{\arraystretch}{0.8} % new height
      \begin{tabular}{ l c c c c c c c c }
        ...
        \multirow{5}{*}{\textbf{Mar}} & w5 && \cellcolor[rgb]{0.78,0.84,0.94} \\ & w6 &&& \cellcolor[rgb]{0.78,0.84,0.94} \\ & w7 &&& \cellcolor[rgb]{0.78,0.84,0.94} \\ & w8 &&& \cellcolor[rgb]{0.78,0.84,0.94} \\ & w9 &&& \cellcolor[rgb]{0.78,0.84,0.94} \\ 
        \multirow{4}{*}{\textbf{Apr}} & w10 &&&& \cellcolor[rgb]{0.86,0.90,0.96} \\ & w11 &&&& \cellcolor[rgb]{0.86,0.90,0.96} \\ & w12 &&&& \cellcolor[rgb]{0.86,0.90,0.96} \\ & w13 &&&& \cellcolor[rgb]{0.86,0.90,0.96} \\ 
