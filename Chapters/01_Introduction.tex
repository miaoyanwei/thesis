...
\begin{table}[h]
    \begin{center}
        ...
        \hline 
        \cellcolor{yellow!70!lime}1 & Investigating (...) \\
        \hline 
        \cellcolor{yellow!60!lime}2 & Indentifying (...) \\
        \hline 
        \cellcolor{yellow!50!lime}3 & Designing (...) \\
        \hline 
        \cellcolor{yellow!40!lime}4 & Using data visualisation techniques (...) \\
        \hline 
        \cellcolor{yellow!30!lime}5 & Developing (...) \\
        \hline 
        \cellcolor{yellow!20!lime}6 & Evaluating (...) \\
        \hline
        \cellcolor{yellow!10!lime}7 & Allowing long-term event tracking (...) \\
        \hline 
        \end{tabular}
        \caption{Objectives}
