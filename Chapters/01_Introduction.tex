...
of configuration optimisations of a household's energy system, 
...
which means it provides more flexible suggestions when a household already owns a \gls{pv} system, 
...
There is a lack of case study research from the user perspective. 
...
This proposed thesis tries to answer:  
how HCI can help households configure their energy sytems to more renewables.
from a techno-economic perspective.
%that enable evaluations of the technological performance and economic feasibility of a household's energy system.
