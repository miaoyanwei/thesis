...
It was evident that bridging the information gap regarding home energy systems requires providing households with comprehensive knowledge of available technologies in the market. 
...
By utilising the FLEX models discovered during the pre-study, 
this recommender will tailor its recommendations to each household's unique situation, 
suggesting technologies that have the potential to save energy costs.
For instance, by learning the location of the house, 
in order to estimate the amount of sunlight it is likely to receive over the course of a year, 
to evaluate whether installing a \gls{pv} system would be a viable and economic way for the household.
...
%As a result, the FLEX models can offer those insights to homeowners, empowering them to make well-informed decisions about their energy system investments. 
...
Therefore, the personalised home energy system recommender serves as the answer to the first research question. 
