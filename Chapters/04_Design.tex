...
However, we also take investment costs into account and filter out the most techno-economic configurations for users.
At the same time, we provide users with the option to explore additional recommendations regardless of investment costs.
