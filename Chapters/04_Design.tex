...
The explanations provided by the system are intended to serve three purposes: 
...
The home page of the website serves the purpose of informing participants about the functionality and process of the service. 
Several factors related to usability are considered in the design and content of the home page:
\begin{description}
  \item[Purpose introduction] The home page clearly communicates the purpose of the service, highlighting its main objective and benefits for participants. This helps users understand the core function and value proposition of the website.
  \item[Explanation of steps] A step explanation is provided to guide users through the process of using the service. 
  \item[Time information] The home page mentions the estimated time required to complete the process or receive the recommendations. 
  \item[Data privacy information] Users are informed about the data handling practices and security measures implemented by the website. 
  \item[Involvement of organisations] The home page introduces the relevant organisations involved in the development and operation of the service to establish credibility in the reliability and expertise of the system.
...
The data collection page is designed with the purpose of gathering information about the household's current energy demand and supply-related factors. 
