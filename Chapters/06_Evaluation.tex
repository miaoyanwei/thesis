...
\begin{center}
  ...
  \begin{longtable}{ | p{.20\textwidth} | p{.70\textwidth} | }
    ...
    \hline
    \multirow{4}{4em}{Learnability} & Have you heard of energy-efficient appliances or renewable energy technologies for households? \\
    ...
    \hline
    \multirow{4}{4em}{Learnability} & Were you familiar with these technologies before using the system? \\
