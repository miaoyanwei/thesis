...
An opportunity to encourage European residents to switch to greener energy options. 
That actually do benefits for not only the environment but also for the planet. 

\section{Research questions}

This paper focuses on investigating European resident's profile types, 
in order to provide easy, accurate and explainable predictions and suggestions for them. 

\begin{itemize}
  \item Residents profiles?
  \item Be explainable? 
\end{itemize}
