...
%The FLEX-Behaviour model \cite{newtrends} facilitates the modeling of household behaviour, including activity profiles and corresponding load profiles. 
